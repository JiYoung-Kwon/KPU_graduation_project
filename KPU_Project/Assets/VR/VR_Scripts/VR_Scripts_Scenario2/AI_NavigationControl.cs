...
public class AI_NavigationControl : MonoBehaviour
{
    private static AI_NavigationControl Navigation;
    public static AI_NavigationControl NAVATION
    {
    ...
    private void Awake()
    {
        Navigation = GetComponent<AI_NavigationControl>();
    }
