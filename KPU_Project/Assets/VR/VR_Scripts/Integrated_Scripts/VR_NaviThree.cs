...
public class VR_NaviThree : MonoBehaviour
{
    #region Singleton
    private static VR_NaviThree navi;
    public static VR_NaviThree NAVI
    {
        get { return navi; }
    }
    ...
    private void Awake()
    {
        navi = GetComponent<VR_NaviThree>();
    }
    #endregion
    ...
    {
        if (Tobii.EventTrigger.ET.secondTrigger)
        {
            Debug.Log("부딪힘");
