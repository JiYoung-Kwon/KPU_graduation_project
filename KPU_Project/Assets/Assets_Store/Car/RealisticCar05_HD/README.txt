...
Car has 2 openable doors . Just select "Car05_Door_Front_Left" or any other door under:
"RealisticCar05_HD_Complete / Car05_Body" and rotate it in Y axis.
...
Just interior is replaced by "RealisticCar05_HD_Interior_RightHanded.fbx" in prefab. Package contains one prefab with Right Handed interior already.
...
Main Body part includes 2 materials. One for Car paint (RealisticCar05_Body - You can adjust color, metallic and smothness freely. 
Also You can make Your own custom paint texture using Car05_Body_PSD file) and second for everything else 
(Car05_Parts - Color, metallic and smothness are defined by textures.
...
All Glasses uses texture for different transparency. Back Windows are less transparent than Front windows and lights glasses.