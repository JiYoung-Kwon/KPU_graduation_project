...
public class Other_navigation : MonoBehaviour
{
    private static Other_navigation navation;
    public static Other_navigation NAVATION
    {
        get { return navation; }
    }
    ...
    private void Awake()
    {
        navation = GetComponent<Other_navigation>();
    }
